...
class PlayersController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $relations = [
            'playerMovieCollections' => \App\PlayerMovieCollection::where('player_id', $id)->get(),
            'playerMovies' => \App\PlayerMovie::where('player_id', $id)->get(),
            'abuses' => \App\Abuse::where('by_player_id', $id)->get(),
        ];

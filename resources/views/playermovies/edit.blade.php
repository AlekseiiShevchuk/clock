...
@section('content')
    ...
    {!! Form::model($playerMovie, ['method' => 'PUT', 'route' => ['playermovies.update', $playerMovie->id], 'files' => true,]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    @if ($playerMovie->movie_file)
                        <a href="{{ asset('uploads/'.$playerMovie->movie_file) }}" target="_blank">Download file</a>
                    @endif
